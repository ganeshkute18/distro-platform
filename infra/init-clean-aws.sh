...
echo "═══════════════════════════════════════════════════════════════"
echo ""
echo "  EC2 API (internal): http://$EC2_IP:4000/api/v1"
echo "  External API:      https://api.distropro.in/api/v1"
echo "  API Docs (internal): http://$EC2_IP:4000/api/v1/docs"
echo "  Health (internal):  http://$EC2_IP:4000/health"
echo ""
...
echo ""
echo "  Next steps:"
echo "    1. Update Vercel env var:  NEXT_PUBLIC_API_URL=https://api.distropro.in/api/v1"
echo "    2. Ensure backend CORS_ORIGINS includes your frontend origin, such as https://distropro.in"
echo "    3. Login as owner and create agencies, products, and pricing rules"
echo "    4. Create customer accounts and test order flow"
echo ""
